...
// Overlay ustiga bosilsa modalni yopish
...
function startTimer(duration, display) {
	...
	setInterval(function () {
		...
		if (--timer < 0) {
			timer = duration; // vaqt tugasa qayta boshlash
		}
	}, 1000);
}

window.onload = function () {
	let twoMinutes = 2 * 60, // 2 daqiqa
		display = document.querySelector('.storis__info-media-title');
